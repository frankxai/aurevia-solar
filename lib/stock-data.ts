...
export const REAL_PRODUCT_CATALOG: ProductItem[] = [
  ...
  },
  {
    id: 'prod-02',
    sku: 'ZOLA-CARPORT-2P',
    name: 'Solar-Carport Zola Pod Executive (2 Stellplätze, Carbon/Alu)',
    category: 'carports',
    brand: 'SolarCarport.tech / Aurevia',
    imageUrl: '/images/luxury-carport.jpg',
    description: 'Ultra-luxuriöses modulares Carbon- & Aluminium-PV-Carport mit integriertem Smart Rain Channel System, ambienter Gold-Illumination und 22kW Dual Wallbox Vorbereitung.',
    specs: { 'Stellplätze': '2 Fahrzeuge', 'Abmessung': '5.90m x 5.50m', 'Regenrinne': 'Smart Rain Channel', 'Schneelastzone': 'Zone 2 & 3 (Harz-Statik)' },
    stockSeesen: 12,
  ...
  },
  {
    ...
    name: 'AC/DC Direct-PV Solar Multi-Split Klimaanlage',
    category: 'climate',
    brand: 'RIAL Energy',
    imageUrl: '/images/direct-pv-klima.jpg',
    description: 'Direkt-PV betriebenes Klimasystem für Penthouse & Anwesen. Speist Solarstrom direkt ohne Wechselrichter-Umwandlungsverluste für Kühlen & Heizen ein.',
    specs: { 'Kühlleistung': '12.000 BTU / 3.5 kW', 'DC-Einspeisung': '80V - 380V Direct', 'SEER': '22.0 High Efficiency', 'Kältemittel': 'R32 Eco' },
    stockSeesen: 34,
    pricePvlager: 899.00,
